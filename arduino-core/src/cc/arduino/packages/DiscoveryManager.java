...
import cc.arduino.packages.discoverers.TeensyDiscovery;
...
public class DiscoveryManager {
  ...
  private final TeensyDiscovery teensyDiscoverer = new TeensyDiscovery();

  public DiscoveryManager() {
    discoverers = new ArrayList<>();
    discoverers.add(serialDiscoverer);
    discoverers.add(networkDiscoverer);
    discoverers.add(teensyDiscoverer);
